    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            // with LastIndexOf
            Console.WriteLine("JQuery Index : {0}",
                aList2.IndexOf("JQuery", 0));
            ...
            string[] customers = { "JQuery", "CSS", "Javascript" };
            ...
            // Number of keys
            Console.WriteLine("*********Dictionaries store key value pairs*********");
            Console.WriteLine("Count : {0}",
                superheroes.Count);
