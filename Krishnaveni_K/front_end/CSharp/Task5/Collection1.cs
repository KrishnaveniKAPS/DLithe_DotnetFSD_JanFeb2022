...
namespace Collection1
{
    class Program
    {
        static void  main(string[] args)
        {
            ...
            // Add an object array
            aList2.AddRange(new object[] { "HTML", "CSS", "SQL" });
            ...
            // are the same
            Console.WriteLine("-----2.Sorting Array----");
            aList2.Sort();
            Console.WriteLine("-----3.Revering  Array----");
            aList2.Reverse();

            // Insert at the 2nd position
            aList2.Insert(1, "Javascript");
            ...
            */
            ...
            // with LastIndexOf
            Console.WriteLine("Javascript Index : {0}",
                aList2.IndexOf("Javascript", 0));
            ...
            Console.WriteLine("-----4,Dictionaries store key value pairs------");
            // Number of keys
